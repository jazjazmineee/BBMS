<%@ Page Title="" Language="C#" MasterPageFile="~/DROPS OF HOPE.Master" AutoEventWireup="true" CodeBehind="ADDBankAffiliation.aspx.cs" Inherits="Group11_IT114_MachineProblem.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="margin-left:auto;margin-right:auto;">
        <tr>
            <td class="auto-style17" style="font-family: 'Segoe UI'" colspan="2"><strong>ADD</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style16"><asp:TextBox ID="officehours" runat="server" Width="100px" Height="25px"></asp:TextBox>
                <strong><asp:RequiredFieldValidator ID="RFVhours" runat="server" ControlToValidate="officehours" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                </strong>
            </td>
        </tr>
        <tr>
            <td class="auto-style15" style="font-family: 'Segoe UI'"><strong>Telephone Number:</strong></td>
            <td class="auto-style16"><asp:TextBox ID="telnum" runat="server" Width="180px" Height="25px" MaxLength="11"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style16">
                    <asp:DropDownList ID="bloodtype" runat="server" Height="25px" AutoPostBack="True" OnSelectedIndexChanged="bloodtype_SelectedIndexChanged">
        ...
        <tr>
            ...
            <td class="auto-style16"><asp:TextBox ID="quantity" runat="server" Width="180px" Height="25px" TextMode="Number"></asp:TextBox>
                ...
                <br />
                <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="quantity" CssClass="auto-style6" ErrorMessage="Must not be negative" Font-Names="Calibri Light" ForeColor="Red" MaximumValue="100" MinimumValue="1" Type="Integer"></asp:RangeValidator>
            </td>
        </tr>
    </table>
    </div>
    ...
    <table class="auto-style2">
        <tr>
            <td class="auto-style13">
                ...
                <br />
                <asp:HyperLink ID="HyperLink8" runat="server" CssClass="auto-style6" Font-Names="Calibri Light" Font-Underline="False" NavigateUrl="~/UPDATEBankAff.aspx" BorderColor="#009933" BorderStyle="Outset" BorderWidth="1px" ForeColor="Black" Width="56px">Update</asp:HyperLink>
