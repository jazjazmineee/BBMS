...
namespace Group11_IT114_MachineProblem
{
    public partial class WebForm12 : System.Web.UI.Page
    {
        ...
        protected void addbtn_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            OleDbCommand search = new OleDbCommand("SELECT * FROM BloodBankInventory where BloodPackID='" + BloodpackBox.Text + "';", con);
            OleDbDataReader sitereader = search.ExecuteReader();
            OleDbCommand searchbank = new OleDbCommand("SELECT * FROM BloodBank where Location='" + locationbox.Text + "';", con);
            ...
            else if (sitereader1.HasRows)
            {
                ...
                OleDbCommand add = new OleDbCommand("INSERT INTO BloodBankInventory VALUES('" + BloodpackBox.Text + "','" + btypebox.Text + "','" + quantitybox.Text + "','" + locationbox.Text + "');");
                add.Connection = con;
                add.ExecuteNonQuery();
                con.Close();
